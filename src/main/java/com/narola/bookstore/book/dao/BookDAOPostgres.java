...
public class BookDAOPostgres implements IBookDAO {
	...
	public List<Book> getAllBooks() throws DatabaseException {
		...
		try {
			...
			while (rs.next()) {
				...
				String bookAmount = rs.getString("amount");
				Double amount = Double.parseDouble(bookAmount);
	...
	public int updateQry(Book book) throws DatabaseException {
		Connection con = null;
		PreparedStatement ps = null;
	...
	public List<Book> searchBookName(String bookNameStr)  throws DatabaseException{
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
	...
	public List<MasterBookFormat> getListOfBookFormatForBookId(int bookId)  throws DatabaseException  {// view book-static data
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		List<MasterBookFormat> masterBookFormat = new ArrayList<>();
		try {
			...
			throw new DatabaseException("Exceptions when show book format and master book by book Id details" + e.getMessage());
		} finally {
			DBConnect.closeResource(ps, rs);
		}
	...
	public List<Integer> getListOfMsBookId(int bookId) throws DatabaseException {
		...
		try {
			...
			throw new DatabaseException("Exceptions when shoq book format details" + e.getMessage());
		} finally {
			DBConnect.closeResource(ps, rs);
		}
